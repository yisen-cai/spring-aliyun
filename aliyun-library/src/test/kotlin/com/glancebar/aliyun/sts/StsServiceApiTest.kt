...
internal class StsServiceApiTest {
    ...
    internal fun setUp() {
        ...
        aliyunConfig[AliyunConfigParams.ALIYUN_STS_ACCESS_KEY_ID] = System.getenv("ACCESS_KEY")
        aliyunConfig[AliyunConfigParams.ALIYUN_STS_ACCESS_KEY_SECRET] = System.getenv("ACCESS_SECRET")
        aliyunConfig[AliyunConfigParams.ALIYUN_STS_ENDPOINT] = System.getenv("ENDPOINT")
        aliyunConfig[AliyunConfigParams.ALIYUN_STS_ACM_ROLE] = System.getenv("ACM_ROLE")
    ...
    internal fun testLocalDateTime() {
        val date =
            LocalDateTime.parse("2021-03-04T17:30:53Z".subSequence(0, 19)).toInstant(ZoneOffset.ofTotalSeconds(0))
        println(date)
